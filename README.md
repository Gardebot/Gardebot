...
- [ ] Enable reminder workflow with escalation
- [ ] Admin override UI for manual assignments
- [ ] Nomination fairness scoring (rotation, fatigue)
...
### Phase 4: Features
- [ ] Multi-language support (externalize strings)
- [ ] Incremental calendar sync (diff-based updates)
- [ ] Webhook signature verification (HMAC)
- [ ] Advanced poll options (multiple choice, custom responses)
